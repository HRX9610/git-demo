		...
		<table width="100%" border=1>
			...
			<tr>
				<td colspan="5" align="center">
					...
					<a href="${pageContext.request.contextPath}/queryItems?pageNum=${pageInfo.prePage}">上页</a>
					<a href="${pageContext.request.contextPath}/queryItems?pageNum=${pageInfo.nextPage}">下页</a>
					<a href="${pageContext.request.contextPath}/queryItems?pageNum=${pageInfo.pages}">尾页</a>
				</td>
			</tr>
		</table>
     </form>
